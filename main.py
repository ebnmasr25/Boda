...
async def neww(client,message):
	...
	xrb3 = """
	✦ [جروب اذاعه القرءان الكريم](https://t.me/em_source)
	
	✦ [ قناة البوستات ](https://t.me/Y9959)
	
	✦ [قناة السوࢪس](https://t.me/em_xrb)
	
	✦ [ جࢪوب تانيه ثانوى مذاكرة](https://t.me/Ul_ll_ll)
	
	✦ [ بوت جاسمن للحمايه](https://t.me/s3e_bot)
	
	يمكنك الدخول للاستفادة 🔥♥✨
	"""
...
async def tanc(client,message):
	...
	await message.reply(
	"**يمكنك الدخول لجروب الدعم لتنصيب مثل هذا البوت**\n\n**جروب الدعم : @em_xr1",reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("-Channel",url="https://t.me/em_xrb3")]]))
